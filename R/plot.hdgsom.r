...
plot.hdgsom <- function(x, type="count", colors=NULL, dim=0, main="", ...){
  ...
  if(type == "count"){
    ...
    if(is.null(x[["training"]])) stop("Trained hdgsom model expected, but obtained different data structure.")
